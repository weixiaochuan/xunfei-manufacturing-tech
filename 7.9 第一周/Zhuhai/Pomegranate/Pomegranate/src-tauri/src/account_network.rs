...
mod tests {
    ...
    fn accepts_local_lan_and_cloud_origins() {
        ...
        assert!(validate_origin("cloud", "https://api.example.com").is_ok());
    }
    ...
    fn rejects_cross_profile_and_unsafe_origins() {
        ...
        assert!(validate_origin("cloud", "http://api.example.com").is_err());
