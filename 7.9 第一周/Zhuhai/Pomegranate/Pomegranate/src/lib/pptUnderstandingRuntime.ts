...
const PPT_DIRECT_UNDERSTANDING_PROMPT_VERSION = "ppt-direct-understanding-v1";
const PPT_CHUNK_UNDERSTANDING_PROMPT_VERSION = "ppt-chunk-understanding-v1";
const PPT_MERGE_UNDERSTANDING_PROMPT_VERSION = "ppt-merge-understanding-v1";
...
function mergePromptFitsBudget(
  ...
  const maxContextTokens =
    Number.isFinite(budget.modelMaxContextTokens) && (budget.modelMaxContextTokens ?? 0) > 0
