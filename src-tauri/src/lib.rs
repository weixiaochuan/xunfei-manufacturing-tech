    ...
    builder
        ...
        .setup(move |app| {
            ...
            #[cfg(desktop)]
            {
                ...
                if cfg!(debug_assertions)
                    && std::env::var("POMEGRANATE_FORCE_VISIBLE_DEV_WINDOW")
                        .ok()
                        .as_deref()
                        == Some("1")
                    && app.get_webview_window("main-visible").is_none()
                {
                    ...
                    .build()
                    {
                        log::error!("[window] failed to create visible dev window: {error}");
                    }
                }
            }
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Full-version feature commands imported from 汇总3.
