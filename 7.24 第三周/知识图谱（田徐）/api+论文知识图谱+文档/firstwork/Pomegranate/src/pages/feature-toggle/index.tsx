...
const TAB_ICONS: Record<MobileTabKey, React.ReactNode> = {
  ...
  "research-assistant": <Microscope size={20} className="text-cyan-600" />,
  "ai-resources": <KeyRound size={20} className="text-teal-600" />,
  marketplace: <Store size={20} className="text-indigo-600" />,
  ...
  settings: <User size={20} className="text-slate-500" />,
};
