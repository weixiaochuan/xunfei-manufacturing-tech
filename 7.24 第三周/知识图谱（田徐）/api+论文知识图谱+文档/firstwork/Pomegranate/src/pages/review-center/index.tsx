    ...
    <Alert
      ...
      description={
        <Space wrap>
          ...
          <Button size="small" onClick={async () => { await marketplaceApi.switchMockRole("developer"); onChanged(); }}>切到创作者</Button>
          <Button size="small" type="primary" onClick={async () => { await marketplaceApi.switchMockRole("admin"); onChanged(); }}>切到管理员</Button>
        </Space>
      }
    />
  );
  ...
  return (
    <div className="commerce-page">
      ...
      <CommerceHero
        ...
        icon={<ShieldCheck size={28} />}
        badge={<Tag color="red">管理员工作区</Tag>}
