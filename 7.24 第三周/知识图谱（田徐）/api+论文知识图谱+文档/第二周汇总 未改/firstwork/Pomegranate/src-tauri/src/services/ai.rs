...
/// - `https://api.deepseek.com/v1`            → `.../v1/chat/completions`（兼容旧配置）
...
#[cfg(test)]
mod openai_chat_url_tests {
    use super::build_openai_chat_url;

    #[test]
    fn uses_current_deepseek_official_endpoint() {
        assert_eq!(
    ...
    #[test]
    fn keeps_legacy_versioned_deepseek_configuration_compatible() {
        assert_eq!(
...
impl AiService {
    ...
    pub async fn chat_stream_with_skills(
        ...
        if extra_system_context.is_some() {
