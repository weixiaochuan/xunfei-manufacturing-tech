...
pub fn run() {
    ...
    builder
        ...
        .setup(move |app| {
            ...
            let tauri_resource_dir = app.path().resource_dir().unwrap_or_else(|_| {
                std::env::current_dir()
            ...
            let dev_resource_dir = std::env::current_dir()
                ...
                .join("src-tauri")
                .join("resources");
            let learning_resource_dir = if tauri_resource_dir.join("learning-assistant").exists()
                || tauri_resource_dir
                    .join("resources")
                    .join("learning-assistant")
                    .exists()
            {
                tauri_resource_dir
            } else {
            ...
            for warning in services::document_sources::DocumentSourceService::initialize_builtin(
                &db,
                &instance_dir,
                &learning_resource_dir,
            ) {
                log::warn!("[document_sources] {warning}");
            }
            for warning in services::document_tree::DocumentTreeService::prepare_learning_uploads(
                &db,
                &instance_dir,
            ) {
                log::warn!("[document_tree] {warning}");
            }
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::plugins::parse_plugin_manifest,
            commands::plugins::validate_plugin_manifest,
            commands::plugins::inspect_plugin_package,
            commands::plugins::calculate_plugin_integrity,
            commands::plugins::compare_plugin_permissions,
            commands::plugins::check_plugin_compatibility,
            commands::plugins::get_plugin_installation,
            commands::plugins::list_plugin_installations,
            commands::plugins::verify_plugin_installation,
            commands::plugins::can_execute_plugin_runtime,
            commands::plugins::plugin_inspect_archive,
            commands::plugins::plugin_install_archive,
            commands::plugins::plugin_update_archive,
            commands::plugins::plugin_rollback,
            commands::plugins::plugin_list_versions,
            commands::plugins::plugin_get_activation_settings,
            commands::plugins::plugin_set_activation_setting,
            commands::plugins::plugin_resolve_enabled_contributions,
            commands::plugins::plugin_record_execution,
            commands::plugins::plugin_feature_invoke_xingchen,
            commands::plugins::plugin_document_summary_toolbar_buttons,
            commands::plugins::plugin_document_mock_summary,
            commands::plugins::plugin_document_summary_insert,
            commands::plugins::plugin_document_summary_agents,
            commands::plugins::plugin_document_summary_config_get,
            commands::plugins::plugin_document_summary_config_set,
            commands::plugins::plugin_document_summary_agent_start,
            commands::plugins::plugin_document_summary_cancel,
            commands::plugins::plugin_document_summary_agent_finalize,
            commands::planning::planning_get_workspace,
            commands::planning::planning_set_enabled,
            commands::planning::planning_save_file,
            commands::planning::planning_apply_update,
            commands::planning::planning_clear,
            commands::planning::planning_export,
            commands::marketplace::marketplace_list_products,
            commands::marketplace::marketplace_get_product,
            commands::marketplace::marketplace_search_products,
            commands::marketplace::marketplace_get_product_version,
            commands::marketplace::marketplace_acquire_product,
            commands::marketplace::marketplace_bind_external_authorization,
            commands::marketplace::marketplace_list_entitlements,
            commands::marketplace::marketplace_list_orders,
            commands::marketplace::marketplace_list_ledger,
            commands::marketplace::marketplace_request_refund,
            commands::marketplace::marketplace_list_reviews,
            commands::marketplace::marketplace_submit_review,
            commands::marketplace::marketplace_install_product,
            commands::marketplace::marketplace_update_product,
            commands::marketplace::marketplace_uninstall_product,
            commands::marketplace::marketplace_enable_product,
            commands::marketplace::marketplace_disable_product,
            commands::marketplace::marketplace_record_permission_rejection,
            commands::marketplace::marketplace_configure_service,
            commands::marketplace::marketplace_list_installed,
            commands::marketplace::marketplace_check_updates,
            commands::marketplace::marketplace_verify_installation,
            commands::marketplace::marketplace_dev_revoke_product_version,
            commands::marketplace::marketplace_dev_restore_product_version,
            commands::marketplace::marketplace_mock_test_product,
            commands::marketplace_supply::marketplace_list_accounts,
            commands::marketplace_supply::marketplace_get_mock_session,
            commands::marketplace_supply::marketplace_switch_mock_role,
            commands::marketplace_supply::marketplace_switch_account,
            commands::marketplace_supply::marketplace_update_account,
            commands::marketplace_supply::marketplace_apply_developer,
            commands::marketplace_supply::developer_list_products,
            commands::marketplace_supply::developer_create_product,
            commands::marketplace_supply::developer_update_product,
            commands::marketplace_supply::developer_create_version,
            commands::marketplace_supply::developer_upload_package,
            commands::marketplace_supply::developer_get_package_report,
            commands::marketplace_supply::developer_submit_product,
            commands::marketplace_supply::developer_submit_version,
            commands::marketplace_supply::developer_list_earnings,
            commands::marketplace_supply::developer_get_dashboard,
            commands::marketplace_supply::admin_list_submissions,
            commands::marketplace_supply::admin_get_submission,
            commands::marketplace_supply::admin_start_review,
            commands::marketplace_supply::admin_approve_submission,
            commands::marketplace_supply::admin_reject_submission,
            commands::marketplace_supply::admin_suspend_product,
            commands::marketplace_supply::admin_restore_product,
            commands::marketplace_supply::admin_delist_product,
            commands::marketplace_supply::admin_revoke_version,
            ...
            commands::credentials::credential_get_usage,
            commands::xingchen_agent::external_agent_list,
            commands::xingchen_agent::external_agent_list_bindable_products,
            commands::xingchen_agent::external_agent_create,
            commands::xingchen_agent::external_agent_update,
            commands::xingchen_agent::external_agent_delete,
            commands::xingchen_agent::external_agent_test_connection,
            commands::xingchen_agent::external_agent_health_check,
            commands::xingchen_agent::agent_session_list,
            commands::xingchen_agent::agent_session_create,
            commands::xingchen_agent::agent_session_delete,
            commands::xingchen_agent::agent_message_list,
            commands::xingchen_agent::agent_send_message,
            commands::xingchen_agent::agent_finalize_plugin_output,
            commands::xingchen_agent::agent_workflow_invoke,
            commands::xingchen_agent::agent_cancel_request,
            commands::xingchen_agent::agent_usage_list,
            commands::xingchen_agent::agent_usage_clear,
            // PPT Master 外部引擎
            ...
            commands::learning_assistant::learning_assistant_ai_get_config,
            commands::learning_assistant::learning_assistant_ai_save_config,
            commands::learning_assistant::learning_assistant_ai_clear_config,
            commands::learning_assistant::learning_assistant_understand,
            commands::learning_assistant::learning_assistant_generate_plan,
            commands::learning_assistant::learning_assistant_adjust_plan,
            commands::document_sources::document_source_list,
            commands::document_sources::document_source_import_learning,
            commands::document_sources::document_source_delete,
            commands::document_tree::document_tree_list,
            commands::learning_kb::learning_kb_search,
            commands::learning_progress::learning_project_create,
            commands::learning_progress::learning_project_delete,
            commands::learning_progress::learning_project_duplicate,
            commands::learning_progress::learning_project_list,
            commands::learning_progress::learning_project_load,
            commands::learning_progress::learning_project_rename,
            commands::learning_progress::learning_project_save,
            commands::learning_progress::learning_progress_clear_latest,
            commands::learning_progress::learning_progress_load_latest,
            commands::learning_progress::learning_progress_save_latest,
            commands::learning_quiz::learning_quiz_get_questions,
            commands::learning_quiz::learning_quiz_score,
            commands::learning_resources::learning_resources_recommend,
            commands::research_papers::research_search_papers,
            commands::research_papers::research_recommend_for_knowledge_base,
            commands::research_analysis::research_analyze_papers,
            ...
            commands::data_dir::get_runtime_data_directory,
            ...
            // 课程知识图谱模块（机械制造工艺图谱，只读安全接口；不混用笔记双向链接图）
            ...
            commands::course_graph_ai::course_graph_ai_analyze,
            commands::course_graph_ai::course_graph_ai_get,
            commands::course_graph_ai::course_graph_ai_review_relation,
            commands::course_graph_ai::course_graph_ai_accepted_graph,
            // AI Provider 注册表
            ...
            commands::ai::finalize_ai_plugin_output,
            ...
            commands::import::scan_supported_import_folder,
            commands::import::import_selected_files,
            commands::import::import_mixed_files,
            ...
            commands::pdf::rebuild_pdf_note_as_editable,
            // 通用源文件 / Word 模块
