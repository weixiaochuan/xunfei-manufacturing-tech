...
const NoteListPage = lazy(() => import("@/pages/notes"));
const NoteEditorPage = lazy(() => import("@/pages/notes/editor"));
...
const AiResourcesPage = lazy(() => import("@/pages/ai-resources"));
...
const ResearchAssistantPage = lazy(() => import("@/pages/research-assistant"));
const ResearchLibraryPage = lazy(() => import("@/pages/research-library"));
...
const router = createHashRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "notes", element: <LazyPage><NoteListPage /></LazyPage> },
      { path: "notes/:id", element: <LazyPage><NoteEditorPage /></LazyPage> },
      ...
      { path: "daily", element: <LazyPage><DailyPage /></LazyPage> },
      ...
      { path: "ai-resources", element: <LazyPage><AiResourcesPage /></LazyPage> },
      ...
      { path: "research-assistant", element: <LazyPage><ResearchAssistantPage /></LazyPage> },
      { path: "research-library", element: <LazyPage><ResearchLibraryPage /></LazyPage> },
