...
export const MOBILE_TAB_REGISTRY: Record<MobileTabKey, MobileTabMeta> = {
  ...
  "learning-assistant": {
    ...
    matchPrefixes: ["/learning-assistant"],
    activeColor: "accent",
  },
  "research-assistant": {
    key: "research-assistant",
    icon: "research-assistant",
    label: "助研",
    path: "/research-assistant",
    matchPrefixes: ["/research-assistant", "/research-library"],
    activeColor: "accent",
  },
  "ai-resources": {
    key: "ai-resources",
  ...
  marketplace: {
    ...
    label: "市场",
    path: "/marketplace",
    matchPrefixes: ["/marketplace", "/developer-center", "/review-center"],
    activeColor: "accent",
  },
  tasks: {
    key: "tasks",
