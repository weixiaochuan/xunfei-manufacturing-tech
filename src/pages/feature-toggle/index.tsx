...
const OPTIONS: OptionMeta[] = [
  ...
  },
  {
    ...
    label: "AI 助研",
    desc: "论文库 / 研究分析 / 学术资料组织",
    icon: <Microscope size={16} className="text-teal-600" />,
    iconBg: "bg-teal-100",
  },
  {
    view: "ai-resources",
    label: "AI 资源中心",
    desc: "统一管理模型凭据 / AI 能力资源",
    icon: <KeyRound size={16} className="text-violet-600" />,
    iconBg: "bg-violet-100",
  },
  {
    view: "marketplace",
    label: "AI 应用市场",
    desc: "插件市场 / 发布 / 审核 / 版本管理",
...
const TAB_ICONS: Record<MobileTabKey, React.ReactNode> = {
  ...
  "learning-assistant": <GraduationCap size={20} className="text-blue-600" />,
  "research-assistant": <Microscope size={20} className="text-teal-600" />,
  "ai-resources": <KeyRound size={20} className="text-violet-600" />,
  marketplace: <Store size={20} className="text-emerald-600" />,
